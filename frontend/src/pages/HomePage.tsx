        ...
        <div style={{ padding: "20px", maxWidth: "900px", margin: "0 auto" }}>
            ...
            <p style={{ color: "var(--color-text-secondary)" }}>Welcome! Select a section below to get started.</p>
             <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginTop: "24px" }}>
                ...
                <Link to="/club-officer" style={{ textDecoration: "none", color: "inherit" }}>
                    <div style={{ border: "1px solid var(--color-border)", borderRadius: "8px", padding: "24px" }}>
                        <h2 style={{ marginTop: 0 }}>Club Officer</h2>
                        <p style={{ color: "var(--color-text-secondary)" }}>Submit budget requests for your organization</p>
                    </div>
                </Link>
